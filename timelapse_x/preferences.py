...
class TLX_AddonPrefs(AddonPreferences):
    ...
    def draw(self, context):
        ...
        if self.edit_mode_behavior == 'SKIP':
            ...
            col = info.column(align=True)
            col.scale_y = 0.8
            col.label(text="✓ Recommended: Safe and stable.", icon='CHECKMARK')
...
def register():
    ...
    logger.info("Registering preferences module")
